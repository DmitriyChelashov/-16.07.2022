...
У Гита еще есть варик зачистить терминал, запутив команду clear. Также можно посмотреть справочку нажав git --help. А еще имеется крутая графика по команде git log --graph.